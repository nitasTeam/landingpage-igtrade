        ...
        <div className="flex items-center gap-3">
          <Select value={language} onValueChange={(val: any) => setLanguage(val)}>
            ...
            <SelectContent className="bg-white border border-slate-100 shadow-xl rounded-xl min-w-[150px] p-1">
              ...
              <SelectItem value="cn" className="cursor-pointer rounded-lg hover:bg-slate-50 focus:bg-slate-50 py-2.5">
                <span className="flex items-center gap-3 font-medium text-slate-900">
                  <span className="text-xl leading-none">🇨🇳</span> <span className="hidden sm:inline">中文</span><span className="sm:hidden">CN</span>
                </span>
              </SelectItem>
            </SelectContent>
          </Select>
